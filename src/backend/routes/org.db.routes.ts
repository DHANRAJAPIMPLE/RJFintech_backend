...
router.post('/validate-initiation', OrgStructureDbController.validateInitiation);
...
router.post('/get-node-by-path-companyid', OrgStructureDbController.getOrgNodeByPathCompanyId);
