...
import type {
  ...
  WorkflowAutoGeneratedItem,
} from './workflow.type';

export class WorkflowController {
  private static formatAutoGeneratedWorkflow(
  ...
  private static formatActiveWorkflow(
    ...
    return {
      ...
      autoGenerated: (workflow.autoGenerated ?? []).map((child) =>
        WorkflowController.formatAutoGeneratedWorkflow(
          child as WorkflowActiveItem | WorkflowActiveInternalItem,
        ),
      ),
